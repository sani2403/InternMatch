        ...
        <div class="row">
            <div class="col-lg-8 course-details-left">
                ...
                <div class="content-wrapper">
                    <h4 class="title">About Certification</h4>
                    <div class="content">
                    ...
                    <!-- </li>
                            <li class="justify-content-between d-flex">
                                <p>Introducing Postman</p> -->
                    <!-- <a class="btn text-uppercase" href="#">View Details</a> -->
                    <!-- </li>
                            <li class="justify-content-between d-flex">
                                <p>Your First API Request</p> -->
                    <!-- <a class="btn text-uppercase" href="#">View Details</a> -->
                    <!-- </li>
                            <li class="justify-content-between d-flex">
                    ...
                    <!-- </li>
                            <li class="justify-content-between d-flex">
                                <p>Sending data with POST</p> -->
                    <!-- <a class="btn text-uppercase" href="#">View Details</a> -->
                    <!-- </li>
                            <li class="justify-content-between d-flex">
                                <p>Introduction to variables and scripting</p> -->
                    <!-- <a class="btn text-uppercase" href="#">View Details</a> -->
                    <!-- </li>
                            <li class="justify-content-between d-flex">
                                <p>PATCH and DELETE</p> -->
                    <!-- <a class="btn text-uppercase" href="#">View Details</a> -->
                    <!-- </li>
                            <li class="justify-content-between d-flex">
                                <p>Generating Code</p> -->
            ...
            <div class="col-lg-4 right-contents">
                ...
                <a href="https://learn.microsoft.com/en-us/credentials/certifications/azure-fundamentals/?practice-assessment-type=certification" class="btn text-uppercase enroll">Apply Here</a>
